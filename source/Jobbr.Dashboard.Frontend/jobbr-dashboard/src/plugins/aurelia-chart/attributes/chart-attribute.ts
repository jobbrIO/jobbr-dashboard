import {inject, customAttribute, bindable, bindingMode, autoinject} from 'aurelia-framework'
...
export class ChartAttribute {
  ...
  constructor(private element: Element, private _modelObserver: ModelObserver) {
  }
